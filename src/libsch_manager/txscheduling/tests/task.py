...
class SimpleTests(TestCase):
    ...
    def test_startingStarted(self):
        """ Test an invalid startService call to a running ScheduledCall """
    ...
    def test_startingInvalidSchedule(self):
        """ Test calling startService with an invalid schedule """
        self.assertRaises(TypeError, self.sc.start,'this is garbage')
    
    def test_testStopCallback(self):
        """ Test startService deferred callback on stop """
        def cb(result):
